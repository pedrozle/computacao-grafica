...
void draw(void) {
    ...
    glColor3f(1, 1, 1);
    glBegin(GL_QUADS);
    glTexCoord2f(0.0f, 0.0f); glVertex2f(-0.35f, 0.70f);
    glTexCoord2f(1.0f, 0.0f); glVertex2f(0.35f, 0.70f);
    glTexCoord2f(1.0f, 1.0f); glVertex2f(0.35f, 0.15f);
    glTexCoord2f(0.0f, 1.0f); glVertex2f(-0.35f, 0.15f);
    glEnd();
    ...
    glColor3f(1, 1, 1);
    glBegin(GL_QUADS);
    glTexCoord2f(0.0f, 0.0f); glVertex2f(-0.80f, 0);
    glTexCoord2f(1.0f, 0.0f); glVertex2f(0.80f, 0);
    glTexCoord2f(1.0f, 1.0f); glVertex2f(0.80f, -0.05f);
    glTexCoord2f(0.0f, 1.0f); glVertex2f(-0.80f, -0.05f);
    glEnd();
    ...
    glColor3f(1, 1, 1);
    glBegin(GL_QUADS);
    glTexCoord2f(0.0f, 0.0f); glVertex2f(-0.75f, -0.08);
    glTexCoord2f(1.0f, 0.0f); glVertex2f(-0.02, -0.08);
    glTexCoord2f(1.0f, 1.0f); glVertex2f(-0.02, -0.8);
    glTexCoord2f(0.0f, 1.0f); glVertex2f(-0.75f, -0.8);
    glEnd();
    ...
    glColor3f(1, 1, 1);
    glBegin(GL_QUADS);
    glTexCoord2f(0.0f, 0.0f); glVertex2f(0.02, -0.08);
    glTexCoord2f(1.0f, 0.0f); glVertex2f(0.75, -0.08);
    glTexCoord2f(1.0f, 1.0f); glVertex2f(0.75, -0.8);
    glTexCoord2f(0.0f, 1.0f); glVertex2f(0.02, -0.8);
    glEnd();
    ...
    glColor3f(1, 1, 1);
    glBegin(GL_QUADS);
    glTexCoord2f(0.0f, 0.0f); glVertex2f(-0.7, -0.82);
    glTexCoord2f(1.0f, 0.0f); glVertex2f(-0.5, -0.82);
    glTexCoord2f(1.0f, 1.0f); glVertex2f(-0.5, -0.98);
    glTexCoord2f(0.0f, 1.0f); glVertex2f(-0.7, -0.98);
    glEnd();
...
// Define o n�mero da textura do cubo.
    ...
    image_t quadro, portaE, portaD, tampo, pes;
    glBindTexture(GL_TEXTURE_2D, texture_id[0]);
    tgaLoad("D:\\computacao-grafica\\aula3\\quadro.tga", &quadro, TGA_FREE | TGA_LOW_QUALITY);
    glBindTexture(GL_TEXTURE_2D, texture_id[1]);
    tgaLoad("D:\\computacao-grafica\\aula3\\portaE.tga", &portaE, TGA_FREE | TGA_LOW_QUALITY);
    glBindTexture(GL_TEXTURE_2D, texture_id[2]);
    tgaLoad("D:\\computacao-grafica\\aula3\\portaD.tga", &portaD, TGA_FREE | TGA_LOW_QUALITY);
    glBindTexture(GL_TEXTURE_2D, texture_id[3]);
    tgaLoad("D:\\computacao-grafica\\aula3\\tampo.tga", &tampo, TGA_FREE | TGA_LOW_QUALITY);
    glBindTexture(GL_TEXTURE_2D, texture_id[4]);
    tgaLoad("D:\\computacao-grafica\\aula3\\pes.tga", &portaD, TGA_FREE | TGA_LOW_QUALITY);
